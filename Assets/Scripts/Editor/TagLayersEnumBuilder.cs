...
public class TagsLayersEnumBuilder : EditorWindow
{
    ...
    static void RebuildTagsAndLayersEnums()
    {
        ...
        var relativePath = "Assets/Scripts/Enums/";

        AssetDatabase.ImportAsset(relativePath + "Tags.cs", ImportAssetOptions.ForceUpdate);
        AssetDatabase.ImportAsset(relativePath + "Layers.cs", ImportAssetOptions.ForceUpdate);
    }
